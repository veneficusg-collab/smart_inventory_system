...
const TopUnstockProducts = () => {
  ...
  const fetchUnstocks = async () => {
    ...
    const { data, error } = await supabase
      .from("logs")
      .select("product_name, product_quantity, created_at, product_action")
    ...
    const grouped = data.reduce((acc, item) => {
      ...
      acc[item.product_name].totalQty += item.product_quantity;
      return acc;
    }, {});
...
export default TopUnstockProducts;
